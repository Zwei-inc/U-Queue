...
<head>
  ...
  <!-- CSS Files -->
  <link href="<?php echo $baseurl ?>assets/css/material-kit.mind1f1.css?v=2.2.0" rel="stylesheet" />
  <link href="assets/css/modal.css" rel="stylesheet" />
  <!-- CSS Just for demo purpose, don't include it in your project -->
  <link href="<?php echo $baseurl ?>assets/demo/demo.css" rel="stylesheet" />
  <link href="<?php echo $baseurl ?>assets/demo/vertical-nav.css" rel="stylesheet" />
  <style>
	.fixed {
	  position: fixed;
	  top: 5%;
